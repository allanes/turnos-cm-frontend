...
import  VideosPage  from '../VideoControlContainer/VideosControlPage';
import  VideoPlaylist  from '../VideoControlContainer/VideoPlaylist';
        ...
        <Router>
          ...
          <div className='pages-container'>
            <Routes>
              ...
              {/* <Route path={categoriesList_sidebar[4].link} element={<VideosPage />} /> */}
              <Route path={categoriesList_sidebar[4].link} element={<VideoPlaylist />} />
